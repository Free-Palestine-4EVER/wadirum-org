...
export const metadata: Metadata = {
  title: "Desert Explorer Package | 2-Day Wadi Rum Experience",
  description:
    "Experience the best of Wadi Rum with our 2-day Desert Explorer package combining jeep tour, camel ride, and hiking for a diverse desert adventure.",
}
    ...
    <div className="bg-white">
      ...
      <div className="relative h-[50vh] md:h-[60vh] lg:h-[70vh] w-full">
        <Image
          ...
          alt="Desert Explorer Package in Wadi Rum"
          fill
          priority
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-4">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">DESERT EXPLORER PACKAGE</h1>
          <p className="text-lg md:text-xl max-w-3xl">
            Experience Wadi Rum through multiple perspectives over 2 unforgettable days
          </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                ...
                <p className="text-lg mb-6">
                  Our Desert Explorer package offers a diverse experience of Wadi Rum through three different modes of
                  exploration: jeep, camel, and on foot. This carefully crafted 2-day itinerary allows you to experience
                  the desert from multiple perspectives, giving you a more complete understanding of this magnificent
                  landscape.
                </p>
                <p className="text-lg mb-6">
                  You'll spend one night at our traditional Bedouin camp, enjoying authentic cuisine under the stars and
                  experiencing the tranquility of the desert at night. This package is perfect for those who want to
                  experience a variety of desert activities in a short timeframe.
                </p>
                <div className="bg-amber-50 p-6 rounded-lg mb-8">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Half-day jeep tour to major Wadi Rum attractions</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-amber-600 mr-2">✓</span>
                      <span>Traditional camel ride at sunset through scenic valleys</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-amber-600 mr-2">✓</span>
                      <span>Morning hiking experience through hidden canyons</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-amber-600 mr-2">✓</span>
                ...
                <div className="bg-gray-50 p-6 rounded-lg sticky top-24">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-amber-600">135 JOD per person</p>
                    ...
                    <div>
                      ...
                      <p>Daily at 10:00 AM from Wadi Rum Village</p>
                    </div>
                    <Link href="#booking">
          ...
          <AnimateOnScroll>
            <div className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold">Day 1: Jeep Tour & Camel Ride</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2">
                  <div className="space-y-4 ml-16">
                    <div>
                      <p className="font-semibold">10:00 AM - Start of the Tour</p>
                      <p>
                    ...
                    <div>
                      <p className="font-semibold">10:30 AM - Lawrence's Spring</p>
                      <p>
                    ...
                    <div>
                      <p className="font-semibold">11:30 AM - Khazali Canyon</p>
                      <p>
                    ...
                    <div>
                      <p className="font-semibold">03:30 PM - Return to Camp</p>
                      <p>
                    ...
                    <div>
                      <p className="font-semibold">04:30 PM - Camel Ride</p>
                      <p>
                        Experience a traditional sunset camel ride through the beautiful valleys near the camp. Your
                        guide will lead you on a 1.5-hour journey, allowing you to experience the desert as Bedouins
                        have for centuries.
                      </p>
                    </div>
                    <div>
                      ...
                      <p>
                        Dismount from your camel at a panoramic viewpoint to watch the sunset transform the desert
                        colors.
                      </p>
                    </div>
                    <div>
                      <p className="font-semibold">07:00 PM - Return to Camp</p>
                      <p>Return to camp by camel as twilight settles over the desert.</p>
                    </div>
                    <div>
                ...
                <div className="md:col-span-1">
                  <div className="relative h-80 rounded-lg overflow-hidden">
                    <Image src="/images/camel-ride.jpg" alt="Camel ride in Wadi Rum" fill className="object-cover" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2">
                  <div className="space-y-4 ml-16">
                    ...
                    <div>
                      <p className="font-semibold">01:00 PM - Return to Camp</p>
                      <p>Return to the camp for lunch and some time to rest.</p>
                    </div>
                    <div>
                      <p className="font-semibold">02:30 PM - Departure</p>
                      <p>
                        After lunch, you'll be transferred back to Wadi Rum Village, concluding your Desert Explorer
                        package.
                      </p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>Half-day jeep tour with English-speaking Bedouin guide</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">✓</span>
                    <span>Sunset camel ride (approximately 1.5 hours)</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">✓</span>
                    <span>Morning guided hiking experience</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">✓</span>
          ...
          <div className="container">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <p>
                  Yes, this package is suitable for children aged 6 and above. Children can ride camels with an adult or
                  on their own if they're comfortable. The hiking portion can be adjusted to accommodate younger
                  participants.
                </p>
              </div>
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h3 className="text-xl font-bold mb-2">Do I need prior experience to ride a camel?</h3>
                <p>
                  No prior experience is necessary. Our camels are well-trained and your guide will provide instructions
                  on how to mount, dismount, and sit comfortably. The camel ride is at a gentle pace suitable for
                  beginners.
                </p>
              </div>
              <div className="bg-white rounded-lg shadow-sm p-6">
